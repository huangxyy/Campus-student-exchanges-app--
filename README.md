...
| **P4-W5** | Week 5 | 🟢 **Done** | 积分等级与进度条、积分兑换页、排行榜多维度 Tab（积分/交易/好评/热心） |
| **P4-W6** | Week 6 | 🟢 **Done** | 维基评论区、投稿审核状态、活动专题页、个人中心积分等级展示 |
| **P4-W7** | Week 7 | 🟢 **Done** | 商品列表查询缓存（30s TTL + 数据变更失效）、商品/动态列表首屏骨架屏、信任徽章自动授予与展示 |
| **P4-W8** | Week 8 | 🟡 **WIP** | 全量测试与提审收口（已完成生产构建，待云环境核验与提审材料整理） |
...
- **积分体系**：积分中心、等级进度条、签到、积分兑换（置顶/加急/头像框）、积分明细；排行榜多维度 Tab（积分榜/交易达人/好评之星/热心帮手）。
- **校园维基**：维基首页/详情/投稿、评论区、投稿待审核状态展示。
- **个人中心**：信任分与等级、积分与积分等级展示、活动专题入口、信任徽章（诚信卖家/热心帮手/靠谱之星）展示。

### 🚀 开发中 (In Progress)
- Week 8：全量测试与提审（构建通过，按 `week8-release-checklist.md` 收口）。
